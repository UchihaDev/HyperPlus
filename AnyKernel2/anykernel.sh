...
insert_line init.rc 'write /dev/stune/top-app/schedtune.boost 10' 'after' 'write /dev/stune/top-app/schedtune.prefer_idle 1' 'write /dev/stune/top-app/schedtune.boost 10'
...
insert_line init.rc 'write /dev/cpuset/top-app/cpus 0-7' 'after' '# update cpusets now that processors are up' 'write /dev/cpuset/top-app/cpus 0-7'
insert_line init.rc 'write /dev/cpuset/foreground/cpus 0-7' 'after' 'write /dev/cpuset/top-app/cpus 0-7' 'write /dev/cpuset/foreground/cpus 0-7'
insert_line init.rc 'write /dev/cpuset/foreground/boost/cpus 0-7' 'after' 'write /dev/cpuset/foreground/cpus 0-7' 'write /dev/cpuset/foreground/boost/cpus 0-7'
insert_line init.rc 'write /dev/cpuset/background/cpus 0-7' 'after' 'write /dev/cpuset/foreground/boost/cpus 0-7' 'write /dev/cpuset/background/cpus 0-7'
insert_line init.rc 'write /dev/cpuset/system-background/cpus 0-7' 'after' 'write /dev/cpuset/background/cpus 0-7' 'write /dev/cpuset/system-background/cpus 0-7'
insert_line init.rc '# set default schedTune value for foreground/top-app (only affects EAS)' 'after' 'write /dev/cpuset/system-background/cpus 0-7' '# set default schedTune value for foreground/top-app (only affects EAS)'
insert_line init.rc 'write /dev/stune/foreground/schedtune.prefer_idle 1' 'after' '# set default schedTune value for foreground/top-app (only affects EAS)' 'write /dev/stune/foreground/schedtune.prefer_idle 1'
insert_line init.rc 'write /dev/stune/top-app/schedtune.prefer_idle 1' 'after' 'write /dev/stune/foreground/schedtune.prefer_idle 1' 'write /dev/stune/top-app/schedtune.prefer_idle 1'
...
insert_line init.rc 'write /sys/module/cpu_boost/parameters/dynamic_stune_boost 15' 'after' 'write /sys/module/cpu_boost/parameters/input_boost_freq "0:1036800"' 'write /sys/module/cpu_boost/parameters/dynamic_stune_boost 15'
insert_line init.rc 'write /sys/module/cpu_boost/parameters/input_boost_ms 500' 'after' 'write /sys/module/cpu_boost/parameters/dynamic_stune_boost 15' 'write /sys/module/cpu_boost/parameters/input_boost_ms 500'
insert_line init.rc 'write /dev/cpuset/top-app/cpus 0-7' 'after' 'write /sys/module/cpu_boost/parameters/input_boost_ms 500' 'write /dev/cpuset/top-app/cpus 0-7'
insert_line init.rc 'write /dev/cpuset/foreground/boost/cpus 0-3,6-7' 'after' 'write /dev/cpuset/top-app/cpus 0-7' 'write /dev/cpuset/foreground/boost/cpus 0-3,6-7'
insert_line init.rc 'write /dev/cpuset/background/cpus 0-1' 'after' 'write /dev/cpuset/foreground/boost/cpus 0-3,6-7' 'write /dev/cpuset/background/cpus 0-1'
insert_line init.rc 'write /dev/cpuset/system-background/cpus 0-3' 'after' 'write /dev/cpuset/background/cpus 0-1' 'write /dev/cpuset/system-background/cpus 0-3'
insert_line init.rc 'write /sys/block/sda/queue/read_ahead_kb 1024' 'after' 'write /dev/cpuset/system-background/cpus 0-3' 'write /sys/block/sda/queue/read_ahead_kb 1024'
